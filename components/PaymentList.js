            ...
            {payments.map((payment) => (
              <div key={payment.id} className="payment-item">
                ...
                <div className="payment-item-actions">
                  {onMoveToOther && !payment.installmentPlanId && (
                    <button
                  ...
                  <button
                    ...
                    title={payment.installmentPlanId ? 'Taksit planından düzenlenir' : 'Düzenle'}
                    disabled={!!payment.installmentPlanId}
                    style={payment.installmentPlanId ? { opacity: 0.35, cursor: 'not-allowed' } : undefined}
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" width="18" height="18">
                  ...
                  <button
                    ...
                    title={payment.installmentPlanId ? 'Taksit planından silinir' : 'Sil'}
                    disabled={!!payment.installmentPlanId}
                    style={payment.installmentPlanId ? { opacity: 0.35, cursor: 'not-allowed' } : undefined}
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" width="18" height="18">
